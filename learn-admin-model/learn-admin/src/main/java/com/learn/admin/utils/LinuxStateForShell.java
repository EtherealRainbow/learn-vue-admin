...
public class LinuxStateForShell {
    ...
    private static final String IP_ADDRESS = "1.116.238.114";
    private static final String USER = "root";
    private static final String PASSWORD = "Wyq030564";


    public static void main(String[] args) {
//        String clearThreeData = "find /home/task/file -atime +3 -exec rm -rf {} \\;";
        String viewFile = "ls /home/task/file";
        String[] commands = {viewFile};
        Map<String, String> result = runDistanceShell(commands, USER, PASSWORD, IP_ADDRESS);
        Map<String, String> stringStringMap = runLocalShell(COMMANDS);
        System.out.println(disposeResultMessage(result));
        System.out.println(disposeResultMessage(stringStringMap));
    }
