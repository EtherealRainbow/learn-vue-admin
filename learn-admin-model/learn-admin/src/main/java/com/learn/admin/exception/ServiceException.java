 ...
 * @author SCKJ-003
 */
public class ServiceException extends com.learn.admin.exception.BaseException {
    ...
    public ServiceException(Throwable t) {
        if (t instanceof com.learn.admin.exception.BaseException) {
            super.setMessageKey(((com.learn.admin.exception.BaseException) t).getMessageKey());
        }
        super.initCause(t);
    }
